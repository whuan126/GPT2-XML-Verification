...
libxml_htmlCtxtReadDoc(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"Ozzzi:htmlCtxtReadDoc", &pyobj_ctxt, &str, &URL, &encoding, &options))
        return(NULL);
    ctxt = (htmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);

    c_retval = htmlCtxtReadDoc(ctxt, str, URL, encoding, options);
...
libxml_namePop(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (libxml_deprecationWarning("namePop") == -1)
        return(NULL);
...
libxml_namePush(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (libxml_deprecationWarning("namePush") == -1)
        return(NULL);
...
libxml_nodePop(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (libxml_deprecationWarning("nodePop") == -1)
        return(NULL);
...
libxml_nodePush(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (libxml_deprecationWarning("nodePush") == -1)
        return(NULL);
...
libxml_xmlCreateDocParserCtxt(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"z:xmlCreateDocParserCtxt", &str))
        return(NULL);

    c_retval = xmlCreateDocParserCtxt(str);
    py_retval = libxml_xmlParserCtxtPtrWrap((xmlParserCtxtPtr) c_retval);
    return(py_retval);
}
...
libxml_xmlCtxtReadDoc(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"Ozzzi:xmlCtxtReadDoc", &pyobj_ctxt, &str, &URL, &encoding, &options))
        return(NULL);
    ctxt = (xmlParserCtxtPtr) PyparserCtxt_Get(pyobj_ctxt);

    c_retval = xmlCtxtReadDoc(ctxt, str, URL, encoding, options);
    py_retval = libxml_xmlDocPtrWrap((xmlDocPtr) c_retval);
    return(py_retval);
}
...
libxml_xmlFreeEntity(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"O:xmlFreeEntity", &pyobj_entity))
        return(NULL);
...
libxml_xmlThrDefDefaultBufferSize(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (libxml_deprecationWarning("xmlThrDefDefaultBufferSize") == -1)
        return(NULL);
...
libxml_xmlThrDefParserDebugEntities(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (libxml_deprecationWarning("xmlThrDefParserDebugEntities") == -1)
        return(NULL);
...
libxml_xmlValidateElement(PyObject *self ATTRIBUTE_UNUSED, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, (char *)"OOO:xmlValidateElement", &pyobj_ctxt, &pyobj_doc, &pyobj_root))
        return(NULL);
    ctxt = (xmlValidCtxtPtr) PyValidCtxt_Get(pyobj_ctxt);
    doc = (xmlDocPtr) PyxmlNode_Get(pyobj_doc);
    root = (xmlNodePtr) PyxmlNode_Get(pyobj_root);

    c_retval = xmlValidateElement(ctxt, doc, root);
    py_retval = libxml_intWrap((int) c_retval);
    return(py_retval);
}
